 ...
 *
 * Both consumers share this: the live terminal display in cmd/record.c and the
 * offline video renderer in media/visualize.c. No ALSA and no I/O, so it is unit
 * testable on its own.
 */
