...
complete -c audiaki -l ir -d 'Monitor through a cab impulse response' -r -F
...
complete -c audiaki -l render -d 'Mix a saved project down and exit' -r -a '(__fish_complete_suffix .aki)'
complete -c audiaki -l bits -d 'Bit depth --render writes' -x -a '16 24 32'
complete -c audiaki -l stems -d '--render writes one file per track instead of one mix'
