...
GUI_CORE_SRCS := $(filter src/backend/%,$(SRCS)) \
                 ...
                 src/audio/loudness.c src/audio/truepeak.c \
                 src/audio/limiter.c src/audio/convolve.c \
...
GUI_TEST_SRC_DEPS := src/gui/autosave.c src/gui/confirm.c src/gui/fonts.c \
                     src/gui/keys.c src/gui/ui.c
